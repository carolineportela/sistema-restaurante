...
//        if (resource.toString().contains("favicon-32")) {
//            return new TransformedResource(resource, new ClassPathResource("static/favicon-32x32.png").getContentAsByteArray());
//        }
//
//        if (resource.toString().contains("favicon-16")) {
//            return new TransformedResource(resource, new ClassPathResource("static/favicon-32x32.png").getContentAsByteArray());
//        }
        ...
        if (resource.toString().contains("index.html")) {
            ...
            try (BufferedReader br = new BufferedReader(isr)) {
                ...
                html = html.replace("Swagger UI", "DZ3 API Definition");
